...
//    (REGISTERED or AWAITING_DELIVERY) and has at least one item where
//    quantityReceived > 0.  PO.status alone is insufficient because a PO
//    moves to RECEIVED only after manual promotion, not automatically.
